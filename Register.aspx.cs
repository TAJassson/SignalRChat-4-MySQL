...
namespace SignalRChat
{
    public partial class Register : System.Web.UI.Page
    {
        ...
        {
            string Query = "insert into livechat_user(UserName,Email,Password)Values('"+txtName.Value+"','"+txtEmail.Value+"','')";
            string ExistQ = "select * from livechat_user where Email='" + txtEmail.Value+"'";
